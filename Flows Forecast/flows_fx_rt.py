...
prx_certificate = vault.get_certificate('ercot')
...
def pull_mis(reportTypeId):
    ...
    factory = VaultFactory()
    vault = factory.get_vault()
    page = get(vault.get_secret('ercot-mis-url')+'misapp/GetReports.do?reportTypeId={}&mimic_duns=1172089695000'.format(reportTypeId), pkcs12_filename=pfx_path, pkcs12_password=prx_credentials.pfx_password)
