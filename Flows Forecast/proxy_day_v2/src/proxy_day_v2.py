...
sys.path.append('.')
sys.path.append('../..')
from writer import write_to_snowflake

from yesapi.yesapi.functions import *
from galaxy_vault.factory import VaultFactory 

#s3 = boto3.resource('s3')
# load dictionary via pickle file
#models_dict = pickle.loads(
 #   s3.Bucket("cdh-nabessmodels-337381")
  #  .Object("forecast_models/models_dict_v2.pkl").get()['Body'].read()
#)

#For local use: load dictionary via pickle file
with open(r"..\models\models_dict.pkl", 'rb') as handle:
...
fx_dict = dict(LOAD_FORECAST=models_dict['load'], WIND_FORECAST=models_dict['wind'], SOLAR_FORECAST=models_dict['solar'], TOTAL_RESOURCE_CAP_OUT=models_dict['outages'])
...
write_to_snowflake(proxy_prices, "BESSUSDATA", "CAISO_MARKET_DATA", "PROXY_PRICES")

write_to_snowflake(nd_proxy_prices, "BESSUSDATA", "CAISO_MARKET_DATA", "ND_PROXY_PRICES")

write_to_snowflake(nd1_proxy_prices, "BESSUSDATA", "CAISO_MARKET_DATA", "ND1_PROXY_PRICES")

write_to_snowflake(nd_proxy_as, "BESSUSDATA", "CAISO_MARKET_DATA", "ND_PROXY_AS")

write_to_snowflake(nd1_proxy_as, "BESSUSDATA", "CAISO_MARKET_DATA", "ND1_PROXY_AS")
...
write_to_snowflake(ranking, "BESSUSDATA", "CAISO_MARKET_DATA", "PROXY_DAY_RANKING")
# %%
